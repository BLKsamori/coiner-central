...
function ErrorBanner( TypeError){
    ...
    switch(TypeError){
        ...
        case "Coin Page":
            MessageError =  Data2Html( `Problem With the SERVER, Please Try again with a few moments.`,  "New Alert" ) ;
            break;
        ...
        case "ReportFull":
            MessageError = Data2Html( "Too Many Coins.<br> Please Remove 1 or more coins to max of 5 Coins in Total.","New Alert" );
            break;
...
function Data2Html( CoinObj , WHatToPrint){
    ...
    switch(WHatToPrint){
        ...
        case "Search":
            ...
            const Compare_Counter_Search = `<div class="counter_box">
                <button class="clean_compare">
                    <i class="Switches bi bi-trash trash_compare" data-target="clear_Compare"></i>
                </button>
        ...
        const ClosedBtn = ` <button class='xBtn' data-target='.searchWrapper'>
                <i class="bi bi-x-square-fill"></i> 
            </button>`;

        const SectionSearched = `<div class="searchWrapper"> 
    ...
    case "reportBanner":
        ...
        CoinObj.forEach( Coin => {
            ...
            <input data-target='${Coin.id}' class="Check switches form-check-input" type="checkbox" id="Check_${Coin.id}">         
        </div>`});
